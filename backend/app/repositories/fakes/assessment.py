...
class FakeAssessmentRepository:
    def __init__(self) -> None:
        self._sessions: InMemoryStore[AssessmentSessionDTO] = InMemoryStore("assessment session")
        self._answers: InMemoryStore[AssessmentAnswerDTO] = InMemoryStore("assessment answer")
