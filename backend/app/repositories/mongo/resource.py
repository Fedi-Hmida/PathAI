...
class MongoResourceRepository:
    def __init__(
        ...
        attachments_collection: Collection[dict[str, Any]],
    ) -> None:
        self._resources: MongoStore[ResourceDTO] = MongoStore(
            resources_collection,
            ResourceDTO,
            "resource",
        )
        self._attachments: MongoStore[ResourceAttachmentDTO] = MongoStore(
