...
class MongoQuizRepository:
    def __init__(
        self,
        quizzes_collection: Collection[dict[str, Any]],
        attempts_collection: Collection[dict[str, Any]],
    ) -> None:
        self._quizzes: MongoStore[QuizDTO] = MongoStore(
            quizzes_collection,
            QuizDTO,
            "quiz",
        )
        self._attempts: MongoStore[QuizAttemptDTO] = MongoStore(
            attempts_collection,
            QuizAttemptDTO,
            "quiz attempt",
        )
